...
my @attributes = ["ChiSquare","Iteration","dataset","Kc","B","lxctr","lyctr","mctr","D","mocsig","lambda","eta","xi","aFactor","edisp","bFWHM","s","bc2b","alpha","R","wavelength","pz","qrzero","nindex","T"];
