...
my @attributes = ["ChiSquare","Iteration","dataset","Kc","B","Lr","Mz","D","mosaic","lambda","eta","xi","aFactor","edisp","bFWHM","s","bc2b","wavelength","pz","qrzero","nindex","T"];
...
foreach my $file(@files)
{
  ...
  while(<PAR>)#This will read the file line by line
  {
		...
		if($things =~ m/set paramArray(Kc)/)
		{
			  ...
			  my $value = $array[2];#the fifth word is the value of a parameter
			  my $shiftcol = 4;
		...
		if($things =~ m/set paramArray(beamFWHM)/)
		{
			  my @array = split(" ",$things);#split by white space
			  my $value = $array[2];#the fifth word is the value of a parameter
			  my $shiftcol = 16;
		...
		if($things =~ m/set paramArray(sDistance)/)
		{
			  my @array = split(" ",$things);#split by white space
			  my $value = $array[2];#the fifth word is the value of a parameter
			  my $shiftcol = 17;
		...
		if($things =~ m/set paramArray(refractiveIndex)/)
		{
			  my @array = split(" ",$things);#split by white space
			  my $value = $array[2];#the fifth word is the value of a parameter
			  my $shiftcol = 24;
